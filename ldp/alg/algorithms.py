...
async def bulk_evaluate_consensus(
    ...
    Returns:
        Two-tuple of the consensus list generated by collections.Counter.most_common
            and the proportion of groups for which the consensus matches the ideal.
    """
...
async def evaluate_consensus(
    ...
    Returns:
        Two-tuple of consensus bins generated by collections.Counter.most_common and the
            consensus answer.
    """
    rand = (
        seed
